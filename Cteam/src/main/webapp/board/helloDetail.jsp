...
<%
	...
	try{
		...
		String sql="select bno,bcategory,btitle,to_char(bdate,'yyyy-mm-dd')as bdate,bcontent,img1,img2,img3,mname,board.mno from board, mem where mem.mno=board.mno and bno="+bno;
