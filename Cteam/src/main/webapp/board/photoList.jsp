...
<%
	...
	String totalSql  = "select count(*) as cnt ";
	   ...
	   totalSql +=" and b.bcategory = '고영희씨 사진첩'";
...
<body>
    <div class="mainBox">
        ...
        <section >
        <form action="photoList.jsp" method="get">
            <div class="middleBar">
            ...
            <div class="body">
				...
				%>
					<a href="photoList.jsp?nowPage=<%=paging.getStartPage()-1%>&searchType=<%=searchType%>&searchValue=<%=searchValue%>">&lt;</a>
				<%
					}
					...
					for(int i=paging.getStartPage();i<=paging.getEndPage(); i++){
						if(i == paging.getNowPage()){
							...
							%>
								<a href="photoList.jsp?nowPage=<%=i%>&searchType=<%=searchType%>&searchValue=<%=searchValue%>"><%=i%></a>
							<%
						}
				...
				%>
						<a href="photoList.jsp?nowPage=<%=paging.getEndPage()+1%>&searchType=<%=searchType%>&searchValue=<%=searchValue%>">&gt;</a>
				<%
